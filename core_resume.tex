  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Managed \textbf{vision tranformers} models in \textbf{Python} to verify customer info with \textbf{98\%} satisfaction from \textbf{8+ clients}}
        \resumeItem{Utilized CosmosDB (Azure) indexing in \textbf{C++ REST APIs} to optimize backend \& reduce query latency by \textbf{70\%}}
      \resumeItemListEnd   
